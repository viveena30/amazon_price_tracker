...
# 1. run the browser
# 2. got to amazon website
# 3. look for items links (scrape)
# 4. put the name of item we are looking for into search bar
# 5. got through multiple pages and scrape all links
# 6. loop through each link annd get all the data of each product
# 7. create a report based on our data.
...
if __name__ == '__main__':
    am = AmazonAPI(BASE_URL, NAME, FILTERS, CURRENCY)
    data = am.run()
